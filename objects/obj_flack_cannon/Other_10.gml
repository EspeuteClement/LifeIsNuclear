...
if (_can_fire_semi_auto && _cooldown <= 0 && btn_shoot && obj_hero._ammo >= 9)
{
	...
	with (instance_create_depth(x,y,depth, obj_bullet_flack))
	{
		_vx = lengthdir_x(4, _angle);
		_vy = lengthdir_y(4, _angle);
	}
